...
asset_root = "../../assets"
soft_asset_file = "urdf/quadruped_v2.urdf"
...
def set_leg_joint_target_position(env, leg_joint_name, target_position):
    joint_handle = gym.get_joint_handle(env, "car_robot", leg_joint_name)
    gym.set_joint_target_position(env, joint_handle, target_position)
...
while not gym.query_viewer_has_closed(viewer):
    ...
    oscillation = math.sin(current_time * 2) * 0.5  # Oscillation amplitude
    
    set_leg_joint_target_position(envs[0], "joint-chassis-front-left-wheel", oscillation)
    set_leg_joint_target_position(envs[0], "joint-chassis-front-right-wheel", oscillation)
    set_leg_joint_target_position(envs[0], "joint-chassis-rare-right-wheel", -oscillation)
    set_leg_joint_target_position(envs[0], "joint-chassis-rare-left-wheel", -oscillation)
